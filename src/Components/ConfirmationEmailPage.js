            ...
            <div className="h-[100vh]  flex justify-evenly">
                ...
                <div className="w-[343px] h-[550px] flex flex-col justify-center gap-[30px]">
                    <div className="w-[300px] text-center">
                        ...
                        <div>
                            <p onClick={handleResendConfirmationEmail} className="cursor-pointer mb-[100px]">Письмо не пришло</p>
                            {isOpen && (
                                <div className="w-[350px] h-[250px] fixed top-1/4 left-1/2 transform -translate-x-1/2 bg-white p-6 rounded-3xl shadow-lg z-50">
                                    <h2 className="text-xl font-semibold mb-4">Мы выслали еще одно письмо на указанную вами почту {email}</h2>
                                    <p>Не забудьте проверить ящик “Спам”!</p>
